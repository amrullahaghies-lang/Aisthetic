...
const Step: React.FC<{ number: string; title: string; description: string; icon: 'image' | 'sparkles' | 'download' }> = ({ number, title, description, icon }) => (
    <div className="flex flex-col items-center text-center">
        <div className="relative mb-4">
            ...
            <div className="absolute -top-1 -left-1 w-8 h-8 bg-cyan-500 text-white font-bold text-sm rounded-full flex items-center justify-center border-4 border-white">
                {number}
            </div>
        </div>
...
export const WelcomeScreen: React.FC = () => {
    return (
        <div className="flex flex-col items-center justify-center h-full animate-fade-in">
            <div className="bg-white border border-gray-200 rounded-3xl shadow-2xl p-8 sm:p-12 text-center max-w-4xl mx-auto">
                ...
                <div className="mt-12 pt-10 border-t border-gray-200">
                    <h2 className="text-2xl font-bold text-slate-800 mb-8">Cara Menggunakan Aplikasi</h2>
